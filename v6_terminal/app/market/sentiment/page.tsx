    ...
    <div className="sentiment-upgrade-container animate-fade-in">
      ...
      <div className="sentiment-header">
        <div className="header-left">
          ...
          <p className="sentiment-subtitle">군중의 심리를 정밀 분석하여 시장의 변곡점을 포착합니다.</p>
        </div>
      ...
      <GlassCard className="tactical-advice-card">
        ...
        <div className="advice-grid">
          <div className="advice-text">
            "현재 기술주 중심의 탐욕 단계가 지속되고 있으나, 개인 투자자들의 심리는 여전히 신중한 편입니다. 이는 폭락보다는 <strong>건전한 조정 후 재상승</strong>의 가능성을 시사합니다."
          </div>
