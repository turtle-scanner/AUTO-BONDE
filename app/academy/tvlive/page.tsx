    ...
    <div className="tv-live-container animate-fade-in">
      <div className="tv-header">
        <h1 className="tv-title">
          <LineChart size={36} className="gold" /> 5-g. [ TVLIVE ] ?ï¦«ëš®?ï¿½??????ï¿½ë»¼?°ï¿½????ç¹¹ë¨®?ï¿½ê¼????ï¿½ëŒ–?¨ëº£?¼é‡ï¿?
        </h1>
        ...
        <div className="control-sidebar">
          <GlassCard className="mobile-command">
            ...
            <div className="command-grid">
              <button className="cmd-btn danger">
                <ShieldAlert size={20} />
                <span>?ï¿½êº‚ï¿½ï¿½ï¿½ï¿½????ï¿½ë„­?¨ï½‹ì³???²ãƒ«??¿½ëµ?ï¿½ë¿ï¿½ì??(EMERGENCY SELL)</span>
              </button>
              <button className="cmd-btn warning">
                <Zap size={20} />
                <span>??ç­Œï¿½?ï§¥ï¿½????ç¹¹ë¨®êµï§‘ï¿?ï¦«ï¿½? (PAUSE BOT)</span>
              </button>
            </div>
            <p className="cmd-desc">?ï¦«ï¿½??????????ï¿½ë˜»ï¿½ë¼¥?ï¦«ëš®?æ´??³¥??ï¿½ï¿½?¥ï¿½ï¿½í” ?²ãƒ«?£é®ë½³ì­•???²ãƒ«??¿½?ˆæ³³ï¿½ï¿½ï¿½ï¿½???????ï¿½ëª´?¨ë£°???ï¦«ëš®?¡ï¿½ë¦ºï¿½ê±???å¯ƒë—ï¿????æºë†ë²???ï¿½ìŠ¦è¸°ï¿½ ?????ï§ê»‹ì¶???????¨ï¿½????ï¿½ëœ„ï¿½ë ¡.</p>
          </GlassCard>
          ...
          <GlassCard className="alert-intelligence">
            ...
            <div className="alert-config">
              <label>??ï¿½êº‚ï§Ÿë‰‘???ï¿½ì”ˆ?·ë…»ë¦°é†«ê·£ì???ï¿½ë„­?¨Îºë®??(Signal Sensitivity)</label>
