...
export default function BacktestPage() {
  ...
  if (loading) return <div className="loading-state">?ÔøΩÍ∫ÅÔøΩÏ??ÔøΩÎº∫??øΩ??ÔøΩÎá°ÔøΩÏä£Á∂?øΩ??ÊøöÔøΩ?..</div>;
    ...
    <div className="backtest-container animate-fade-in">
      <div className="header-row">
        <div className="title-section">
          ...
          <p>?ÔøΩÎÑ≠?®ÔΩãÏ≥?? <span className="highlight">Advanced Bonde Strategy v3.0</span> | ?ÔøΩÍ∫ÅÔøΩÏ??ÔøΩÔøΩ?±ÔøΩ? 2024-01-01 ~ 2024-04-10</p>
        </div>
