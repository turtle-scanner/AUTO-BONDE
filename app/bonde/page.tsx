...
export default function BondeCommandPage() {
  ...
  useEffect(() => {
    const fetchScan = async () => {
      try {
        const res = await fetch('/v6-api/bonde/scan');
    ...
    <div className="bonde-container animate-fade-in">
      <div className="bonde-header">
        <div className="title-area">
          ...
          <p>Mark Minervini & Stockbee ?ÔøΩÍ∫ÅÔøΩÏ??ÔøΩÎÑÅÔøΩÔøΩ??Á∏ïÔøΩ????ÁππÎ®Æ?®Áå∑Ôø??Ë¢Å‚ë∏Ï¶µÁçíÔø?????âÎ®Ø??øΩÎπ?/p>
        </div>
            ...
            <div className="strategy-desc">
              <div className="setup-item">
                ...
                <div>
                  ...
                  <p>?ÔøΩÏîà?∑ÎÖªÎ¶????????âÎ®Æ?èÔøΩÔøΩÔøΩ????ÔøΩÔøΩ?§ÔºòÔß•ÔøΩ/???Ê∫êÎÜÅÎ±??ÔøΩÍ∫ÅÔøΩÏ??ÔøΩÎÑÅÔøΩÔøΩ????ÔøΩÎº®?????≤Íæß?óÔøΩÎ´???????ëÔøΩ?(Volume 3x+)</p>
                </div>
              </div>
              <div className="setup-item">
                ...
                <div>
                  ...
                  <p>?ÔøΩÍµùÔøΩÎí©?? ?ÔøΩÍ∫ÇÔøΩÔøΩÔøΩÔøΩÁ≠åÎù≤?óÁî±Ôø????ÔøΩÔøΩ?§Î≤†ÊØìÔøΩ???ÔøΩÏîà?∑ÎÖªÎ¶∞ÈÜ´Í∑£Ï??TI65) ??ÔøΩÎ´ÅÔøΩÔøΩÔøΩÍµ•ÂΩõÔøΩ???????≤„É´?£ÔøΩ????/p>
                </div>
              </div>
              <div className="setup-item">
                ...
                <div>
                  ...
                  <p>??ÔøΩÎºî?????????í„Çå???âÏò®Ôø?ÔøΩÏîàÔøΩÏùà? ??????ÔøΩÎªπ?æÔøΩ ?≤„É´?£ÔøΩ???????®ÎöÆÎº????ÔøΩÎèÜÔøΩÎ†∞ ?ÔøΩÔøΩ?§Î≤†Ê∫êÔøΩ???????/p>
                </div>
              </div>
            </div>
          </GlassCard>
            ...
            <div className="risk-metrics">
              <div className="risk-box">
                ...
                <div className="info">
                  ...
                  <p>??ÁØÄ??≥ÆËæ±ÔøΩ???????0.5% - 1% ????ÖÔøΩÔøΩÍ≤¶ÔøΩÍº•???ÔøΩÎÑ≠?®ŒªÏßÉÔøΩÍ±°?????ÔøΩÍ∫ÇÔøΩÎµ≤</p>
                </div>
              </div>
              <div className="risk-box">
                ...
                <div className="info">
                  ...
                  <p>??ÔøΩÎ´ÅÔøΩÔøΩÔøΩÍ∫Ç?ÑÔøΩ ?????ÔøΩÎñ£ÔøΩÎÄ??Ô¶´ÔøΩ?, ??ÔøΩÎ´Å‰ºäÔøΩ???????ÔøΩÎñ£ÔøΩÎÄ??ÔøΩÔøΩ?§Î≤†Ê∫êÔøΩ??(?ÔøΩÍ∫ÅÔøΩÏ?????????</p>
                </div>
              </div>
            </div>
          </GlassCard>
