  ...
  const news = [
    {
      ...
      time: '14:24',
      source: 'REUTERS',
      title: '?…ï¿½?¿ë—ª??????ç­Œë¯ ëµï¿½ï¿????ï¿½ë«ï¿½ï¿½ï¿½ë²ê¼??????å½›ï¿½????ï¿½ë???? ?????ï¿½ì”ˆ?·ë…»ë¦°ï¿½?ï¿½ë¹??²ãƒ«?£ï¿½????,
      category: 'ECONOMY',
      sentiment: 'BULLISH',
      isUrgent: true
    },
    {
      ...
      time: '14:15',
      source: 'BLOOMBERG',
      title: '???‰ë¨®?????‰ë¨¯??? ?²ãƒ«?“å ‰ê³ë•Ÿ?¨ï¿½ï¿½ë¹?? AI ????ï¿½ë‡????ï¿½ë„­?¨Îºë°???ï¿½êµï¿½ë’©?????????ï¿½ë?è¸°ì¡¿ë¤????ï¿½ë¼¦ï¿½ì‘‚?? ??ï¿½ï¿½?¤ë² ?„ï¿½????¨ëº¥ï¿½ï¿½ ?²ãƒ«?ªï¿½ë§??ï¿½ì‡Š?,
      category: 'TECH',
      sentiment: 'BULLISH',
      isUrgent: false
    },
    {
      ...
      time: '13:58',
      source: 'CNBC',
      title: '???, ?ï¦«ëš®?æ´ï¿????æºë‚‡ê¼????ï¿½ë?è¸°ï¿½?ï¿½ê¶ï¿½ë’™??ï¦«ëš®?æ´ï¿???ï¿½êº‚ï¿½ï¿½ï¿½ï¿½????ï¦«ëš®?æ´??µ³???ï¿½ë?ï¿½ë’§???ï¿½ì”ˆï¿½ìˆ???ï¿½ë®‚ï¿½ë¹???ç­Œï¿½?ï¿½ï¿½ï¿?,
      category: 'POLICY',
      sentiment: 'BEARISH',
      isUrgent: true
    },
    {
      ...
      title: '?ï¿½êºï¿½ê½”??æ£ºï¿½ë£±ç’ëº£ë‡ï¿½ë????ï¿½ë‡?????è²«ï¿½?????ï¿½ë?è¸°ï¿½?????ï¿½ë«šè«?¿½ ??? ??ï¿½ï¿½?¤ë²¨ï¿½ë£’ ???¥ï¿½?ï¿½ëŸ¢',
      category: 'ENERGY',
      sentiment: 'BEARISH',
      isUrgent: false
    },
    {
      ...
      time: '12:45',
      source: 'MARKETWATCH',
      title: '4?????????²ãƒ«?£ï¿½??????ï¿½ï¿½ï¿½ï¿½ï¿?ç­Œë¨¯?¸è‚‰ï¿????ï¿½ëª­????ï¿½ëª­??ï¦«ëš®Ä²ï¿½ê±??,
      category: 'ECONOMY',
      sentiment: 'NEUTRAL',
      isUrgent: false
    }
    ...
    <div className="news-dashboard animate-fade-in">
      ...
      <div className="news-header">
        <div className="header-info">
          ...
          <p className="news-subtitle">?ï¿½êºï¿½ê½”??æ£ºï¿½ë£±ç’ëº£ë‡ï¿½ë?????ï¿½ì †??ï¦«ëš®?¡ï¿½ë§Šäº¦?…ì‰¥?°ï¿½?ï¿½ìŠœï¿½ë’„??????¨ëº£ë¹?ï¿½ì”ˆ?·ï¿½?????‰ï¿½??ï¿½ì”ˆ?·ë†ƒ???æ¿šìšŒê¼¬ï¿½ê¶¡ï¿½êº????ï¿½ëœ„ï¿½ë ¡.</p>
        </div>
      ...
      <div className="news-layout">
        ...
        <div className="news-sidebar">
          ...
          <GlassCard className="alert-box">
            ...
            <p>??ï¿½ëŒ–?¨ëº£?¼é‡ï¿???AI?ï¿½ì”ˆï¿½ìˆ? ?ï¿½ë„­?¨ï½‹ì³????ç­Œë??£æ²…ï¿???ï¦«ëš®?ï¿½ë«???…ï¿½?¿ë—ª??ï¿½ë´»ï¿½ï¿½?ï¿½ë„­? ??ç¹¹ë¨®êµ›ï¿½???¨ëš®????15% ?äº?»‹ê¼¨æ´ï¿½ç”•ï¿???ï¿½ì”ˆ?·ë†ƒ??????¨ï¿½????ï¿½ëœ„ï¿½ë ¡. ?²ãƒ«??¿½ëµ?????ï¿½êº‚ï§Ÿë‰‘??????ï¿½ë????????ï¿½ì’??´ï¿½???</p>
          </GlassCard>
        </div>
      </div>
