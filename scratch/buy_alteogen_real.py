...
def buy_alteogen_real_after_market():
    print("="*60)
    print("REAL ACCOUNT BUY ORDER: Alteogen (196170) 1 Share")
    print("="*60)
    ...
    try:
        ...
        print(f"Sending REAL order: {params}")
        ...
        if res.isOK():
            ...
            print("\nFAILED: Real order execution failed.")
...
if __name__ == "__main__":
    buy_alteogen_real_after_market()
